...
genai.configure(api_key = "AIzaSyDhR27uqFUzSsIiCyUrRnYhEjTOxXO32zI") #not included as it is considered best practice
model = genai.GenerativeModel("gemini-1.5-flash-8B")# load wanted model
